...
public class ArdiumFluids {
    ...
    public static Fluid customFluid, fluidFakeWater;


    public static void initialization () {
        //if (!FluidRegistry.registerFluid (customFluid)) customFluid = FluidRegistry.getFluid (CUSTOM_FLUID_NAME);
        if (!FluidRegistry.registerFluid (fluidFakeWater)) fluidFakeWater = FluidRegistry.getFluid (ArdiumFluids.FAKE_WATER_FLUID_NAME);
    }
