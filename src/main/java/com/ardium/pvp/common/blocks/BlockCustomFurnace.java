...
public class BlockCustomFurnace extends BlockContainer
{
    ...
    {
        return Item.getItemFromBlock(ArdiumBlocks.ardium_furnace);
    }
    ...
    public boolean onBlockActivated(World world, int posX, int posY, int posZ, EntityPlayer player, int p_149727_6_, float p_149727_7_, float p_149727_8_, float p_149727_9_)
    {
        ...
        {
            TileEntityCustomFurnace tileEntityCustomFurnace = (TileEntityCustomFurnace) world.getTileEntity(posX, posY, posZ);

            if (tileEntityCustomFurnace != null)
            {
                player.openGui(Ardium.instance, 1, world, posX, posY, posZ);
            }
    ...
    public static void updateFurnaceBlockState(boolean p_149931_0_, World p_149931_1_, int p_149931_2_, int p_149931_3_, int p_149931_4_)
    {
        ...
        if (p_149931_0_)
        {
            p_149931_1_.setBlock(p_149931_2_, p_149931_3_, p_149931_4_, ArdiumBlocks.ardium_lit_furnace);
        }
        else
        {
            p_149931_1_.setBlock(p_149931_2_, p_149931_3_, p_149931_4_, ArdiumBlocks.ardium_furnace);
        }
    ...
    public void onBlockPlacedBy(World p_149689_1_, int p_149689_2_, int p_149689_3_, int p_149689_4_, EntityLivingBase p_149689_5_, ItemStack p_149689_6_)
    {
        ...
        {
            ((TileEntityCustomFurnace)p_149689_1_.getTileEntity(p_149689_2_, p_149689_3_, p_149689_4_)).func_145951_a(p_149689_6_.getDisplayName());
        }
    }
    ...
    public void breakBlock(World p_149749_1_, int p_149749_2_, int p_149749_3_, int p_149749_4_, Block p_149749_5_, int p_149749_6_)
    {
        if (!field_149934_M)
        {
            TileEntityCustomFurnace tileEntityCustomFurnace = (TileEntityCustomFurnace)p_149749_1_.getTileEntity(p_149749_2_, p_149749_3_, p_149749_4_);

            if (tileEntityCustomFurnace != null)
            {
                for (int i1 = 0; i1 < tileEntityCustomFurnace.getSizeInventory(); ++i1)
                {
                    ItemStack itemstack = tileEntityCustomFurnace.getStackInSlot(i1);
