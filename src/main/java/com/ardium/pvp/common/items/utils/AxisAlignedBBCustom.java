...
public class AxisAlignedBBCustom
{
    public double minX;
    public double minY;
    public double minZ;
     ...
     */
    public static AxisAlignedBBCustom getBoundingBox(double p_72330_0_, double p_72330_2_, double p_72330_4_, double p_72330_6_, double p_72330_8_, double p_72330_10_)
    {
        return new AxisAlignedBBCustom(p_72330_0_, p_72330_2_, p_72330_4_, p_72330_6_, p_72330_8_, p_72330_10_);
    }

    protected AxisAlignedBBCustom(double p_i2300_1_, double p_i2300_3_, double p_i2300_5_, double p_i2300_7_, double p_i2300_9_, double p_i2300_11_)
    {
     ...
     */
    public AxisAlignedBBCustom setBounds(double p_72324_1_, double p_72324_3_, double p_72324_5_, double p_72324_7_, double p_72324_9_, double p_72324_11_)
    {
     ...
     */
    public AxisAlignedBBCustom addCoord(double p_72321_1_, double p_72321_3_, double p_72321_5_)
    {
        double d3 = this.minX;
        double d4 = this.minY;
        double d5 = this.minZ;
     ...
     * y, z
     */
    public AxisAlignedBBCustom expand(double p_72314_1_, double p_72314_3_, double p_72314_5_)
    {
    ...
    public AxisAlignedBBCustom func_111270_a(AxisAlignedBBCustom p_111270_1_)
    {
     ...
     * y, z
     */
    public AxisAlignedBBCustom getOffsetBoundingBox(double p_72325_1_, double p_72325_3_, double p_72325_5_)
    {
        /**
         * Returns a bounding box with the specified bounds. Args: minX, minY, minZ, maxX, maxY, maxZ
         */
     ...
     */
    public double calculateXOffset(AxisAlignedBBCustom p_72316_1_, double p_72316_2_)
    {
     ...
     * calculated offset.  Otherwise return the calculated offset.
     */
    public double calculateYOffset(AxisAlignedBBCustom p_72323_1_, double p_72323_2_)
    {
     ...
     * calculated offset.  Otherwise return the calculated offset.
     */
    public double calculateZOffset(AxisAlignedBBCustom p_72322_1_, double p_72322_2_)
    {
    ...
    /**
     * Returns whether the given bounding box intersects with this one. Args: AxisAlignedBBCustom
     */
    public boolean intersectsWith(AxisAlignedBBCustom p_72326_1_)
    {
     ...
     */
    public AxisAlignedBBCustom offset(double p_72317_1_, double p_72317_3_, double p_72317_5_)
    {
     ...
     */
    public AxisAlignedBBCustom contract(double p_72331_1_, double p_72331_3_, double p_72331_5_)
    {
     ...
     */
    public AxisAlignedBBCustom copy()
    {
        /**
         * Returns a bounding box with the specified bounds. Args: minX, minY, minZ, maxX, maxY, maxZ
         */
    ...
    /**
     * Sets the bounding box to the same bounds as the bounding box passed in. Args: AxisAlignedBBCustom
     */
    public void setBB(AxisAlignedBBCustom p_72328_1_)
    {
